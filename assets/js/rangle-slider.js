...
(function() {
  ...
  function checkDependencies() {
      ...
      if (typeof noUiSlider === 'undefined') {
          console.error('noUiSlider no está disponible. Esperando...');
          setTimeout(checkDependencies, 100);
          return;
      }
      if (typeof wNumb === 'undefined') {
          console.error('wNumb no está disponible. Esperando...');
          setTimeout(checkDependencies, 100);
          return;
      }
      initRangeSliders();
              ...
              if ($("#slider-range2").length > 0) {
                  ...
                  if (rangeSlider2) {
                      ...
                      rangeSlider2.noUiSlider.on("update", function(values, handle) {
                          ...
                          document.getElementsByName("min-value2")[0].value = sqftFormat.from(values[0]);
                          document.getElementsByName("max-value2")[0].value = sqftFormat.from(values[1]);
                      });
                  }
              }

              // Slider Precio Adicional
              if ($("#slider-range3").length > 0) {
                  ...
                  if (rangeSlider3) {
                      ...
                      rangeSlider3.noUiSlider.on("update", function(values, handle) {
                          ...
                          document.getElementsByName("min-value3")[0].value = moneyFormat3.from(values[0]);
                          document.getElementsByName("max-value3")[0].value = moneyFormat3.from(values[1]);
                      });
                  }
              }

              // Slider Pies Cuadrados Adicional
              if ($("#slider-range4").length > 0) {
                  ...
                  if (rangeSlider4) {
                      ...
                      rangeSlider4.noUiSlider.on("update", function(values, handle) {
                          ...
                          document.getElementsByName("min-value4")[0].value = sqftFormat4.from(values[0]);
                          document.getElementsByName("max-value4")[0].value = sqftFormat4.from(values[1]);
                      });
                  }
              }

          } catch (error) {
              console.error('Error inicializando Range Sliders:', error);
